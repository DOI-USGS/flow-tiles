...
tar_option_set(packages = c('tidyverse', 'lubridate', 'geofacet',
                            'cowplot','ggfx', 'showtext', 'xml2', 'rsvg'))
...
list(
  ...
  tar_target(
    dv,
    read_csv("https://labs.waterdata.usgs.gov/visualizations/data/flow_conditions_202207.csv", col_types = "cTnnnn")
  ),
  tar_target(
    date_start,
